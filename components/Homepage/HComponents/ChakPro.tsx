...
const ChakPro = () => {
  return (
    <Box maxW="7xl" mx="auto" px={{ base: '0', lg: '12' }} py={{ base: '0', lg: '12' }}  bgColor='rgba(255, 255, 255, .10)' borderRadius='2xl' style={{backdropFilter: 'blur(5px)'}} boxShadow='lg'>
